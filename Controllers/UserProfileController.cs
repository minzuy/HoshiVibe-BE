...
namespace HoshiVibe.Controllers
{
    ...
    public class UserProfileController : Controller
    {
        ...
        [HttpPut("update-profile/{userId}/{profileId}")]
        public IActionResult UpdateProfile(Guid userId, Guid profileId, [FromBody] ProfileUpdateDTO dto)
        {
            dto.User_Id = userId;
            dto.UserProfile_Id = profileId;

            var result = _profileService.UpdateProfile(dto);
